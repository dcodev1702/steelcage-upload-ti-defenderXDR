# Synthetic Threat Intelligence for Defender XDR ([Upload API](https://learn.microsoft.com/en-us/azure/sentinel/stix-objects-api))
## Azure Container Instance Deployment

This solution generates synthetic STIX/TAXII v2.1 compliant threat intelligence and automatically uploads it to Microsoft Defender XDR via TI Upload REST API, containerized for Docker or Azure Container Instances (ACI).
